...
var canvas = document.createElement('canvas');
			...
			var geometry = new THREE.SphereGeometry(size/2,60,120,0,Math.PI).rotateZ(Math.PI/4).scale(1,0.07,0.02),
				skinIndices = [],
				skinWeights = [];
			...
			var material = new THREE.MeshPhongMaterial({color:'midnightblue',flatShading:true,shininess:150}),
			...
			var bubblesGeometry = new THREE.BufferGeometrys();
